...
- Traverse les murs, les obstacles, l'eau et les personnages.
- Ne modifie jamais la ROM.
...
désinstaller l'addon. Le gestionnaire de mods permet également de désactiver
complètement l'addon.

## Prudence

Marcher hors du parcours prévu peut contourner des événements ou placer le
joueur dans une zone sans issue. Sauvegardez avant d'explorer, puis désactivez
l'option si vous souhaitez retrouver les collisions normales.
